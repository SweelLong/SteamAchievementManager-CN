namespace SAM.Game
{
	partial class Manager
	{
		...
		private void InitializeComponent()
		{
            ...
            this._StoreButton.Text = "提交变更";
            this._StoreButton.ToolTipText = "存储活动游戏的成就和统计数据。";
            ...
            this._ReloadButton.ToolTipText = "刷新活动游戏的成就和统计数据。";
            ...
            this._ResetButton.ToolTipText = "重置活动游戏的成就和/或统计数据。";
            ...
            this._MainStatusStrip.Text = "状态条1";
            // 
            // _CountryStatusLabel
            // 
            ...
            this._LockAllButton.ToolTipText = "锁定全部成就。";
            ...
            this._InvertAllButton.Text = "逆转全部";
            this._InvertAllButton.ToolTipText = "逆转全部成就。";
            ...
            this._UnlockAllButton.ToolTipText = "解锁全部成就。";
            ...
            this._EnableStatsEditingCheckBox.Text = "我知道修改数值可能会出事但我愿为此买单。";
            ...
            this._DisplayUnlockedOnlyButton.Text = "解锁";
            ...
            this._DisplayLockedOnlyButton.Text = "锁定";
            ...
            this._MatchingStringTextBox.ToolTipText = "键入名称或描述中必须出现的至少3个字符";
            ...
            this.Name = "Manager";
            this.Text = "Steam 成就管理器 7.0 汉化版 - by SweelLong";
