...
namespace SAM.Game
{
    internal partial class Manager : Form
    {
        ...
        public Manager(long gameId, API.Client client)
        {
            ...
            this._StatisticsDataGridView.Columns[0].DataPropertyName = "显示名";

            this._StatisticsDataGridView.Columns.Add("value", "价值");
            ...
            this._StatisticsDataGridView.Columns[1].DataPropertyName = "价值";
            ...
            this._StatisticsDataGridView.Columns[2].DataPropertyName = "额外";
        ...
        private bool LoadUserGameStatsSchema()
        {
            ...
            foreach (var stat in stats.Children)
            {
                ...
                switch (type)
                {
                    ...
                    default:
                    {
                        throw new InvalidOperationException("无效的统计类型");
                    }
                }
            }
        ...
        private void RefreshStats()
        {
            ...
            {
                MessageBox.Show(this, "失败.", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void OnStatDataError(object sender, DataGridViewDataErrorEventArgs e)
        {
            if (e.Context == DataGridViewDataErrorContexts.Commit)
            {
                ...
                if (e.Exception is Stats.StatIsProtectedException)
                {
                    ...
                    e.Cancel = true;
                    view.Rows[e.RowIndex].ErrorText = "统计受到保护你不能修改它";
                }
                else
                {
                    e.ThrowException = false;
        ...
        private void OnCheckAchievement(object sender, ItemCheckEventArgs e)
        {
            ...
            if ((info.Permission & 3) != 0)
            {
                MessageBox.Show(
                    this,
                    "对不起，这是一个受保护的成就，无法使用Steam成就管理器进行修改。",
                    "错误",
                    MessageBoxButtons.OK,
                    MessageBoxIcon.Error);
